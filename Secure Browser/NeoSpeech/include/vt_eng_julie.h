#ifndef VT_ENG_JULIE_H
#define VT_ENG_JULIE_H
...
_DllMode(short)	VT_LOADTTS_ENG_Julie(HWND hWnd, int nSpeakerID, char *db_path, char *licensefile);
_DllMode(void)	VT_UNLOADTTS_ENG_Julie(int nSpeakerID);
...
_DllMode(short) VT_LOAD_UserDict_ENG_Julie(int dictidx, char *filename);
_DllMode(short) VT_UNLOAD_UserDict_ENG_Julie(int dictidx);
...
#if defined(WIN32)
	_DllMode(short) VT_PLAYTTS_ENG_Julie(HWND hcaller, UINT umsg, char *text_buff, int nSpeakerID, int pitch, int speed, int volume, int pause, int dictidx, int texttype);
	_DllMode(void)	VT_STOPTTS_ENG_Julie(void);
	_DllMode(void)	VT_RESTARTTTS_ENG_Julie(void);
	_DllMode(void)	VT_PAUSETTS_ENG_Julie(void);
#endif
...
_DllMode(short) VT_TextToFile_ENG_Julie(int fmt, char *tts_text, char *filename, int nSpeakerID, int pitch, int speed, int volume, int pause, int dictidx, int texttype);
...
_DllMode(int) VT_TextToBuffer_ENG_Julie(int fmt, char *tts_text, char *output_buff, int *output_len, int flag, int nThreadID, int nSpeakerID, int pitch, int speed, int volume, int pause, int dictidx, int texttype);



/*===========================================================================*/
/* CONFIGURE API */
_DllMode(void) VT_SetPitchSpeedVolumePause_ENG_Julie(int pitch, int speed, int volume, int pause, int nSpeakerID);
_DllMode(void) VT_SetCommaPause_ENG_Julie(int pause, int nSpeakerID);



/*===========================================================================
SYNOPSIS
	int VT_GetTTSInfo_ENG_Julie(int request, char *licensefile, void *value, int valuesize);
...
_DllMode(int) VT_GetTTSInfo_ENG_Julie(int request, char *licensefile, void *value, int valuesize);
