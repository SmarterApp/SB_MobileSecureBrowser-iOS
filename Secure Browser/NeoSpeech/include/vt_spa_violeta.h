#ifndef VT_SPA_VIOLETA_H
#define VT_SPA_VIOLETA_H
...
_DllMode(short)	VT_LOADTTS_SPA_Violeta(HWND hWnd, int nSpeakerID, char *db_path, char *licensefile);
_DllMode(void)	VT_UNLOADTTS_SPA_Violeta(int nSpeakerID);
...
_DllMode(short) VT_LOAD_UserDict_SPA_Violeta(int dictidx, char *filename);
_DllMode(short) VT_UNLOAD_UserDict_SPA_Violeta(int dictidx);
...
#if defined(WIN32)
	_DllMode(short) VT_PLAYTTS_SPA_Violeta(HWND hcaller, UINT umsg, char *text_buff, int nSpeakerID, int pitch, int speed, int volume, int pause, int dictidx, int texttype);
	_DllMode(void)	VT_STOPTTS_SPA_Violeta(void);
	_DllMode(void)	VT_RESTARTTTS_SPA_Violeta(void);
	_DllMode(void)	VT_PAUSETTS_SPA_Violeta(void);
#endif
...
_DllMode(short) VT_TextToFile_SPA_Violeta(int fmt, char *tts_text, char *filename, int nSpeakerID, int pitch, int speed, int volume, int pause, int dictidx, int texttype);
...
_DllMode(int) VT_TextToBuffer_SPA_Violeta(int fmt, char *tts_text, char *output_buff, int *output_len, int flag, int nThreadID, int nSpeakerID, int pitch, int speed, int volume, int pause, int dictidx, int texttype);



/*===========================================================================*/
/* CONFIGURE API */
_DllMode(void) VT_SetPitchSpeedVolumePause_SPA_Violeta(int pitch, int speed, int volume, int pause, int nSpeakerID);
_DllMode(void) VT_SetCommaPause_SPA_Violeta(int pause, int nSpeakerID);



/*===========================================================================
SYNOPSIS
	int VT_GetTTSInfo_SPA_Violeta(int request, char *licensefile, void *value, int valuesize);
...
_DllMode(int) VT_GetTTSInfo_SPA_Violeta(int request, char *licensefile, void *value, int valuesize);
